...
return [
    ...
    */
    ...
    'disableTypoToleranceOnAttributes' => ['domain'],
    ...
    */
    ...
    'attributesForFaceting' => [
        'filterOnly(name)',
        'filterOnly(domain)',
        'filterOnly(phone_numbers)',
        'filterOnly(social_media_links)',
        'filterOnly(social_media_links.url)',
        'filterOnly(social_media_links.platform)'
    ],
